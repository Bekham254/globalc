    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-2xl font-bold text-green-400 mb-4">CardVault</h3>
            <p className="text-gray-300 mb-4">
              Your trusted darkweb marketplace for premium credit cards with instant USDT payments 
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">&copy; 2025 CardVault. All transactions secured with USDT cryptocurrency.</p>
        </div>
      </div>
    </footer>
  );
